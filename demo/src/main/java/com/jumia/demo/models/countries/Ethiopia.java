...
@Data
public class Ethiopia implements ICountry {
    Integer id;
    String phone;
    String name;
    String state;
    ...
    static final String regex = ".[1-59]\\d{8}$ ";

    public Ethiopia(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public void setState() {
        this.state =
                Pattern.matches(Ethiopia.regex,this.getPhone()) == true ? "Valid" : "InValid";
    }
