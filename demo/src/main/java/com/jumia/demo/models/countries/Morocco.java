...
@Data
public class Morocco implements ICountry {
    Integer id;
    String phone;
    String name;
    String state;
    ...
    static final String regex = ".[5-9]\\d{8}$ ";

    public Morocco(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public void setState() {
        this.state =
                Pattern.matches(Morocco.regex,this.getPhone()) == true ? "Valid" : "InValid";
    }
